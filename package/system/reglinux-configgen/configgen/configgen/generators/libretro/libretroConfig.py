...
from settings.settingsFile import UnixSettings
...
coreToRetroachievements = {'arduous', 'beetle-saturn', 'blastem', 'bluemsx', 'bsnes', 'cap32', 'desmume', 'duckstation', 'fbneo', 'fceumm', 'flycast', 'flycastvl', 'freechaf', 'freeintv', 'gambatte', 'gearboy', 'gearcoleco', 'geargrafx', 'genesisplusgx', 'handy', 'holani', 'kronos', 'mednafen_lynx', 'mednafen_ngp', 'mednafen_psx', 'mednafen_supergrafx', 'mednafen_wswan', 'mgba', 'melonds', 'melondsds', 'mesen', 'mesens', 'mgba', 'mupen64plus-next', 'neocd', 'o2em', 'opera', 'parallel_n64', 'pce', 'pce_fast', 'pcfx', 'pcsx_rearmed', 'picodrive', 'pokemini', 'potator', 'ppsspp', 'prosystem', 'quasi88', 'quicknes', 'sameduck', 'smsplus', 'snes9x', 'snes9x_next', 'stella', 'swanstation', 'uzem', 'vb', 'vba-m', 'vecx', 'virtualjaguar'}
